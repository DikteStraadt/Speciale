...
class ReadVisitations:
    ...
    def transform(self, data, y=None):
        ...
        headers_visitation_0 = ('first_visitation', 'transversal', 'age_at_first_visitation')
        headers_visitation_1 = ('second_US', 'transversal1', 'age_at_second_US')
        headers_visitation_2 = ('third_US', 'transversal2', 'age_at_third_US')
        headers_visitation_3 = ('fourth_US', 'transversal3', 'age_at_fourth_US')
        headers_visitation_4 = ('fifth_US', 'transversal4', 'age_at_fifth_US')
        headers_visitation_5 = ('sixth_US', 'transversal5', 'age_at_sixth_US')
        headers_visitation_6 = ('seventh_US', 'transversal6', 'age_at_seventh_US')
        headers_visitation_7 = ('eighth_US', 'transversal7', 'age_at_eighth_US')
        headers_visitation_8 = ('ninth_US', 'transversal8', 'age_at_ninth_US')
        headers_visitation_9 = ('tenth_US', 'transversal9', 'age_at_tenth_US')
        headers_visitation_10 = ('eleventh_US', 'transversal10', 'age_at_eleventh_US')
        headers_visitation_11 = ('twelfth_US', 'transversal11', 'age_at_twelfth_US')
        headers_visitation_12 = ('thirteenth_US', 'transversal12', 'age_at_thirteenth_US')
        headers_visitation_13 = ('fourteenth_US', 'transversal13', 'age_at_fourteenth_US')
        headers_visitation_14 = ('fifteenth_US', 'transversal14', 'age_at_fifteenth_US')
        headers_visitation_15 = ('sixteenth_US', 'transversal15', 'age_at_sixteenth_US')
        headers_visitation_16 = ('seventeenth_US', 'transversal16', 'age_at_seventeenth_US')
        ...
        for visitation in visitation_headers:
            ...
            if len(visitation) == 3:
                list_visitations.insert(0, 'age_at_visitation', data[visitation[2]])
