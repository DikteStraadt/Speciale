...
def rename_report_file():
    ...
    new_filename = f"report (timeliness={json_data['timeliness']}, encoding={json_data['encoding']}, fetures_statistical={json_data['feature selection']} {json_data['timestamp']}.json"
